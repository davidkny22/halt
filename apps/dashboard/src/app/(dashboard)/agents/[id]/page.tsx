          ...
          style={{
            backgroundColor:
              config.status === "active"
                ...
                : "rgba(239, 68, 68, 0.1)",
            color:
              config.status === "active" ? "var(--color-green)" : "var(--color-coral)",
          }}
        >
          {config.status}
        </span>
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-xs mt-1" style={{ color: "var(--color-text-secondary)" }}>
              ...
              Blocks everything — no manual intervention needed.
            </p>
          </div>
          ...
          <button
            ...
            style={{
              backgroundColor: enabled ? "var(--color-coral)" : "var(--color-border)",
            }}
          >
            <span
        ...
        {enabled && (
          <div className="flex flex-col gap-5">
              ...
              <div className="flex gap-2">
                {WINDOW_OPTIONS.map((opt) => (
                  <button
                    ...
                    style={{
                      backgroundColor:
                        windowMinutes === opt.value ? "var(--color-coral)" : "var(--color-bg)",
            ...
            >
              ...
              Clawnitor will automatically kill it. The agent will be fully stopped — no actions can execute until manually resumed.
            </div>
          </div>
        )}
